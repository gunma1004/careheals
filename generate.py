...
# 서울 25개 구, 경기 전체 시·군·구, 인천 2군 9구 통합 행정구역 데이터
all_regions = [
    # --- [서울시 25개 구] ---
    ...
    # --- [경기도 전체 시·군 및 세부 구 (44개 전 지역)] ---
    {"sido": "gyeonggi", "sido_name": "경기", "path": "suwon_jangan", "name": "수원시 장안구", "dongs": [{"name": "정자동", "path": "jeongjadong"}, {"name": "조원동", "path": "jowondong"}, {"name": "파장동", "path": "pajangdong"}, {"name": "율천동", "path": "yulcheondong"}, {"name": "송림동", "path": "songrimdong"}]},
    ...
    {"sido": "gyeonggi", "sido_name": "경기", "path": "goyang_deogyang", "name": "고양시 덕양구", "dongs": [{"name": "화정동", "path": "hwajeongdong"}, {"name": "행신동", "path": "haengsindong"}, {"name": "삼송동", "path": "samsongdong"}, {"name": "원흥동", "path": "wonheungdong"}, {"name": "지축동", "path": "jichukdong"}]},
    ...
    {"sido": "gyeonggi", "sido_name": "경기", "path": "yongin_giheung", "name": "용인시 기흥구", "dongs": [{"name": "구갈동", "path": "gugaldong"}, {"name": "동백동", "path": "dongbaekdong"}, {"name": "신갈동", "path": "singaldong"}, {"name": "보정동", "path": "bojeongdong"}, {"name": "마북동", "path": "mabukdong"}]},
...
for reg in all_regions:
    ...
    # 🌟 시도 폴더 아래에 구 폴더가 생성되도록 경로 설정 (예: gyeonggi/suwon_paldal)
    dir_path = os.path.join(sido_path, gu_path)
...
print(f"✨ 경기도 44개 전 지역을 포함하여 서울, 경기, 인천의 모든 구·동·샵 페이지 및 사이트맵이 완벽하게 생성되었습니다!")